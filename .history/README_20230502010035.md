...
[here](https://opensource.salesforce.com/STAVER/latest/index.html). A A command-line way to get started quickly demo can be found [here](https://sfr-omnixai-demo.herokuapp.com/).