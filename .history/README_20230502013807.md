...
## Documentation
For an in-depth understanding of STAVER's usage and a thorough grasp of each parameter's purpose and functionality, we strongly recommend referring to the comprehensive STAVER documentation. This resource offers detailed, step-by-step guidance, illustrative examples, and clear explanations, empowering users to adeptly navigate and harness the full capabilities of the software.
