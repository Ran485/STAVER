...
def peptide_scoring(
    data, weight_variation=1, weight_frequency=5, CV_thresh=1, non_linear=False
):
    """
...
if __name__ == '__main__':
    ...
    result.to_csv(
        '/Volumes/T7_Shield/staver/results/DIA_repeat20/processed_data/Protein_matrix_score_result_6.csv',
        index=False,
    )
