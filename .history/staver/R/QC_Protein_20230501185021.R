...
p + scale_color_brewer(palette = "Paired") +
  ...
  theme(
    axis.text.x = element_text(angle = 0, hjust = 0.6, colour = "black", family = "ArialMT", size = 0), # 设置x轴刻度标签的字体显示倾斜角度为15度，并向下调整1(hjust = 1)，字体簇为Times大小为20
