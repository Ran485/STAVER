...
## --------------- scatter CV plot ------------
QC_data_cv = read.csv("/Users/ranpeng/Desktop/DIA-QC/results/QC_repeat90_highCI_peptides_cv/90QC_data_cv.csv", check.names = F)
colnames(QC_data_cv)
genes = QC_data_cv
...
genes$CV_threshold = ifelse(genes$`Coefficient of Variation [%]` < 5, "CV% < 5",
                         ifelse(genes$`Coefficient of Variation [%]` < 10, "CV% < 10",
                                ifelse(genes$`Coefficient of Variation [%]` < 15, "CV% < 15",
...
## --------------- cumulative CV plot ------------
genes = read.csv("/Users/ranpeng/Desktop/DIA-QC/results/QC_repeat90_highCI_peptides_cv/90QC_data_cv.csv", check.names = F)
colnames(genes)
genes$CV_threshold = ifelse(genes$`Coefficient of Variation [%]` < 5, "CV% < 5",
                            ifelse(genes$`Coefficient of Variation [%]` < 10, "CV% < 10",
                                   ifelse(genes$`Coefficient of Variation [%]` < 15, "CV% < 15",
