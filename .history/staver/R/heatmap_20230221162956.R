...
matrix=read.csv("/Volumes/T7_Shield/DIANN_Data/merge_data/data/processed_data/Barplot_Normal/heatmap_biomarker.csv",header=T,
                skip =0,row.names = 1)
...
#color for subtype
annotation_col = read.csv ('/Volumes/T7_Shield/DIANN_Data/merge_data/data/processed_data/Barplot_Normal/heatmap_ana.csv',header = T,row.names = 1)
...
chending_color = c(colorRampPalette(c("#0772BC", "white"))(50),  ## #184D87  常用#1E90FF ##14417C ## 0772BC ## #395F90黑蓝   ## 淡蓝#1E90FF
...
# matrix = log2(matrix+1)
pheatmap(matrix,cluster_rows=5,cluster_cols=0,
