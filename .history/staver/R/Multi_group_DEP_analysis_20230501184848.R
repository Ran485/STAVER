...
## -------------- load file ----------------------
if (TRUE) {
  input_path <- "/Volumes/Samsung_T5/DIA-QC/results/covid19-2/method_compare/Orignal_data.csv"
  anno_path <- "/Volumes/Samsung_T5/DIA-QC/results/covid19-2/method_compare/Oringanl_ana.csv"
  ...
  ## 数据存储路径
  setwd("/Volumes/Samsung_T5/DIA-QC/results/covid19-2/method_compare/outpath")
  outpath <- getwd()
}
### 相关卡值
AdjPvalueCutoff <- 1
