...
## -------------- load file ----------------------
if (TRUE) {
  input_path <- "~/DIANN_Data/merge_data/data/processed_data/DEP/IPX0002924001/IPX0002924001_fot_normal.csv"
  anno_path <- "~/DIANN_Data/merge_data/data/processed_data/DEP/IPX0002924001/group_ana_normal.csv"
