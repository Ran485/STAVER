...
The STAVER project Hosted on GitHub adheres to the [MIT](https://opensource.org/licenses/MIT) License, ensuring open access and flexibility for users to utilize, modify, and distribute the software according to their needs while maintaining the original copyright and license notices. 