...
## License
Hosted on GitHub, the STAVER project abides by the [MIT](https://opensource.org/licenses/MIT) License, granting users open access and the flexibility to employ, adapt, and share the software as needed, while preserving the original copyright and license acknowledgements.

The STAVER project on GitHub adheres to the [MIT](https://opensource.org/licenses/MIT) License, ensuring open access and flexibility for users to utilize, modify, and distribute the software according to their needs while maintaining the original copyright and license notices. 